...
public partial class AppContext : DbContext
{
    ...
    public virtual DbSet<AnimeTitile> AnimeTitiles { get; set; }
    ...
    public object GenreTitles { get; internal set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    {
        modelBuilder.Entity<AnimeTitile>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("anime_titiles_pkey");

            entity.ToTable("anime_titiles");
        ...
        modelBuilder.Entity<TitlesGenre>(entity =>
        {
            ...
            entity.HasOne(d => d.AnimeTitile).WithMany(p => p.TitlesGenres)
        ...
        modelBuilder.Entity<TitlesStatus>(entity =>
        {
            ...
            entity.HasOne(d => d.AnimeTitile).WithMany(p => p.TitlesStatuses)
                .HasForeignKey(d => d.IdAnime)
                .HasConstraintName("fk_titles_statuses_to_nanime_titles");
